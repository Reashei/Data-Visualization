...
fig, ax = (
    plt.subplots()
)  # subplots wywoluje wykres (1 lub wiecej). Zmienna fig przedstawia caly rysunek, a ax jeden wykres na rysunku
ax.plot(
    input_values, squares, linewidth=5
)  # plot probuje wyswqietlic te liczby w logiczny sposob, jako 1 parametr to wartosci na osi x,
